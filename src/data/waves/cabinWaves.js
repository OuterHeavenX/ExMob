...
export const CABIN_WAVES = Object.freeze([
  ...
  },
  {
    ...
    prepTime: 45, warningTime: 5, activeCap: 8, payout: 900, bountyAfter: 35000,
    music: 'combat_mid',
    groups: [
      { delay: 0, arrival: { type: 'vehicle', route: 'driveway', slot: 'B', vehicle: 'VEH_Sedan_A' },
      ...
      { delay: 10, arrival: { type: 'foot', route: 'east_trees' },
  ...
  },
  {
    ...
    prepTime: 45, warningTime: 5, activeCap: 8, payout: 1500, bountyAfter: 50000,
    ...
    groups: [
      ...
      { delay: 20, arrival: { type: 'foot', route: 'west_trees' },
        enemies: [{ type: 'soldier', count: 1 }, { type: 'enforcer', count: 1 }] },
    ],
  },
]);
